...
# 2 - Atlanta Braves
ATL <- rbind(fetch("ATL", 1990), fetch("ATL", 1991), fetch("ATL", 1992), fetch("ATL", 1993), fetch("ATL", 1994), 
...
save(ATL, file="data/raw/ATL.rda")

# 3 - Baltimore Orioles
BAL <- rbind(fetch("BAL", 1990), fetch("BAL", 1991), fetch("BAL", 1992), fetch("BAL", 1993), fetch("BAL", 1994), 
...
save(BAL, file="data/raw/BAL.rda")

# 4 - Boston Red Sox
BOS <- rbind(fetch("BOS", 1990), fetch("BOS", 1991), fetch("BOS", 1992), fetch("BOS", 1993), fetch("BOS", 1994), 
...
save(BOS, file="data/raw/BOS.rda")

# 5 - Chicago Cubs
CHC <- rbind(fetch("CHC", 1990), fetch("CHC", 1991), fetch("CHC", 1992), fetch("CHC", 1993), fetch("CHC", 1994), 
...
save(CHC, file="data/raw/CHC.rda")

# 6 - Chicago White Sox
CHW <- rbind(fetch("CHW", 1990), fetch("CHW", 1991), fetch("CHW", 1992), fetch("CHW", 1993), fetch("CHW", 1994), 
...
save(CHW, file="data/raw/CHW.rda")

# 7 - Cincinnati Reds
CIN <- rbind(fetch("CIN", 1990), fetch("CIN", 1991), fetch("CIN", 1992), fetch("CIN", 1993), fetch("CIN", 1994), 
...
save(CIN, file="data/raw/CIN.rda")

# 8 - Cleveland Indians
CLE <- rbind(fetch("CLE", 1990), fetch("CLE", 1991), fetch("CLE", 1992), fetch("CLE", 1993), fetch("CLE", 1994), 
...
save(CLE, file="data/raw/CLE.rda")

# 9 - Colorado Rockies
COL <- rbind(fetch("COL", 1993), fetch("COL", 1994), fetch("COL", 1995), fetch("COL", 1996), fetch("COL", 1997), 
             fetch("COL", 1998), fetch("COL", 1999), fetch("COL", 2000), fetch("COL", 2001), fetch("COL", 2002), 
             fetch("COL", 2003), fetch("COL", 2004), fetch("COL", 2005), fetch("COL", 2006), fetch("COL", 2007), 
             fetch("COL", 2008), fetch("COL", 2009), fetch("COL", 2010), fetch("COL", 2011), fetch("COL", 2012), 
             fetch("COL", 2013), fetch("COL", 2014))
save(COL, file="data/raw/COL.rda")

# 10 - Detroit Tigers
DET <- rbind(fetch("DET", 1990), fetch("DET", 1991), fetch("DET", 1992), fetch("DET", 1993), fetch("DET", 1994), 
...
save(DET, file="data/raw/DET.rda")

# 11 - Houston Astros
HOU <- rbind(fetch("HOU", 1990), fetch("HOU", 1991), fetch("HOU", 1992), fetch("HOU", 1993), fetch("HOU", 1994), 
...
save(HOU, file="data/raw/HOU.rda")

# 12 - Kansas City Royals
KCR <- rbind(fetch("KCR", 1990), fetch("KCR", 1991), fetch("KCR", 1992), fetch("KCR", 1993), fetch("KCR", 1994), 
...
save(KCR, file="data/raw/KCR.rda")

# 13 - Los Angeles Angels of Anaheim
LAA <- rbind(fetch("CAL", 1990), fetch("CAL", 1991), fetch("CAL", 1992), fetch("CAL", 1993), fetch("CAL", 1994), 
...
save(LAA, file="data/raw/LAA.rda")

# 14 - Los Angeles Dodgers
LAD <- rbind(fetch("LAD", 1990), fetch("LAD", 1991), fetch("LAD", 1992), fetch("LAD", 1993), fetch("LAD", 1994), 
...
save(LAD, file="data/raw/LAD.rda")

# 15 -Miami Marlins
MIA <- rbind(fetch("FLA", 1993), fetch("FLA", 1994), fetch("FLA", 1995), fetch("FLA", 1996), fetch("FLA", 1997), 
             fetch("FLA", 1998), fetch("FLA", 1999), fetch("FLA", 2000), fetch("FLA", 2001), fetch("FLA", 2002), 
             fetch("FLA", 2003), fetch("FLA", 2004), fetch("FLA", 2005), fetch("FLA", 2006), fetch("FLA", 2007), 
             fetch("FLA", 2008), fetch("FLA", 2009), fetch("FLA", 2010), fetch("FLA", 2011), fetch("MIA", 2012), 
             fetch("MIA", 2013), fetch("MIA", 2014))
save(MIA, file="data/raw/MIA.rda")

# 16 - Milwaukee Brewers
MIL <- rbind(fetch("MIL", 1990), fetch("MIL", 1991), fetch("MIL", 1992), fetch("MIL", 1993), fetch("MIL", 1994), 
...
save(MIL, file="data/raw/MIL.rda")

# 17 - Minnesota Twins
MIN <- rbind(fetch("MIN", 1990), fetch("MIN", 1991), fetch("MIN", 1992), fetch("MIN", 1993), fetch("MIN", 1994), 
...
save(MIN, file="data/raw/MIN.rda")

# 18 - New York Mets
NYM <- rbind(fetch("NYM", 1990), fetch("NYM", 1991), fetch("NYM", 1992), fetch("NYM", 1993), fetch("NYM", 1994), 
...
save(NYM, file="data/raw/NYM.rda")

# 19 - New York Yankees
NYY <- rbind(fetch("NYY", 1990), fetch("NYY", 1991), fetch("NYY", 1992), fetch("NYY", 1993), fetch("NYY", 1994), 
...
save(NYY, file="data/raw/NYY.rda")

# 20 - Oakland Athletics
OAK <- rbind(fetch("OAK", 1990), fetch("OAK", 1991), fetch("OAK", 1992), fetch("OAK", 1993), fetch("OAK", 1994), 
...
save(OAK, file="data/raw/OAK.rda")

# 21 - Philadelphia Phillies
PHI <- rbind(fetch("PHI", 1990), fetch("PHI", 1991), fetch("PHI", 1992), fetch("PHI", 1993), fetch("PHI", 1994), 
...
save(PHI, file="data/raw/PHI.rda")

# 22 - Pittsburgh Pirates
PIT <- rbind(fetch("PIT", 1990), fetch("PIT", 1991), fetch("PIT", 1992), fetch("PIT", 1993), fetch("PIT", 1994), 
...
save(PIT, file="data/raw/PIT.rda")

# 23 - San Diego Padres
SDP <- rbind(fetch("SDP", 1990), fetch("SDP", 1991), fetch("SDP", 1992), fetch("SDP", 1993), fetch("SDP", 1994), 
...
save(SDP, file="data/raw/SDP.rda")

# 24 - Seattle Mariners
SEA <- rbind(fetch("SEA", 1990), fetch("SEA", 1991), fetch("SEA", 1992), fetch("SEA", 1993), fetch("SEA", 1994), 
...
save(SEA, file="data/raw/SEA.rda")

# 25 - San Francisco Giants
SFG <- rbind(fetch("SFG", 1990), fetch("SFG", 1991), fetch("SFG", 1992), fetch("SFG", 1993), fetch("SFG", 1994), 
...
save(SFG, file="data/raw/SFG.rda")

# 26 - St Louis Cardinals
STL <- rbind(fetch("STL", 1990), fetch("STL", 1991), fetch("STL", 1992), fetch("STL", 1993), fetch("STL", 1994), 
...
save(STL, file="data/raw/STL.rda")

# 27 - Tampa Bay Rays
TBR <- rbind(fetch("TBD", 1998), fetch("TBD", 1999), fetch("TBD", 2000), fetch("TBD", 2001), fetch("TBD", 2002), 
             fetch("TBD", 2003), fetch("TBD", 2004), fetch("TBD", 2005), fetch("TBD", 2006), fetch("TBD", 2007), 
             fetch("TBR", 2008), fetch("TBR", 2009), fetch("TBR", 2010), fetch("TBR", 2011), fetch("TBR", 2012), 
             fetch("TBR", 2013), fetch("TBR", 2014))
save(TBR, file="data/raw/TBR.rda")

# 28 - Texas Rangers
TEX <- rbind(fetch("TEX", 1990), fetch("TEX", 1991), fetch("TEX", 1992), fetch("TEX", 1993), fetch("TEX", 1994), 
...
save(TEX, file="data/raw/TEX.rda")

# 29 - Toronto Blue Jays
TOR <- rbind(fetch("TOR", 1990), fetch("TOR", 1991), fetch("TOR", 1992), fetch("TOR", 1993), fetch("TOR", 1994), 
...
save(TOR, file="data/raw/TOR.rda")

# 30 - Washington Nationals
WSN <- rbind(fetch("MON", 1990), fetch("MON", 1991), fetch("MON", 1992), fetch("MON", 1993), fetch("MON", 1994), 
...
save(WSN, file="data/raw/WSN.rda")
